...
public class PokemonDemo {
	...
	public static void main(String[] args) {
		...
		IPokemonCatcherService<List<List<String>>> newPokedexAdapter = new LegacyToMapPokedexAdapter(newPokedexService, legacyToMapPokemonDataMapper, mapToLegacyPokemonDataMapper);
